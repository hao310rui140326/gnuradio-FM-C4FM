...
# Training settings
parser = argparse.ArgumentParser(description='C4FM TX')
...
parser.add_argument('lo_freq', type=int,default=155194500 )
parser.add_argument('tx_db', type=float,default=10 )
...
lo_freq_ini = args.lo_freq;
tx_db_ini = args.tx_db;
...
class c4fm_tx_db(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "c4fm_tx_db")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("c4fm_tx_db")
        ...
        self.settings = Qt.QSettings("GNU Radio", "c4fm_tx_db")
        ...
        self.tx_file = tx_file = './data'
        self.tx_db = tx_db = tx_db_ini
        self.samp_rate = samp_rate = 38400
        self.lo_freq = lo_freq = lo_freq_ini
        ...
        self._tx_db_range = Range(0, 89.75, 0.25, tx_db_ini, 359)
        ...
        self._lo_freq_range = Range(80000000, 6000000000, 100, lo_freq_ini, 200)
        ...
        ##self.iio_fmcomms2_sink_0_0 = iio.fmcomms2_sink_f32c('192.168.3.2', lo_freq, 2304000, 300000, True, False, 0x8000, False, 'A', tx_db, 10.0, '', True)
...
def main(top_block_cls=c4fm_tx_db, options=None):
