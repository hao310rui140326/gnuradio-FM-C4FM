...
class c4fm_tx_params(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "c4fm_tx_params")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("c4fm_tx_params")
        ...
        self.settings = Qt.QSettings("GNU Radio", "c4fm_tx_params")
        ...
        ##self.tx_file = tx_file = './c4fm_music.pcm'
        ...
        self.iio_fmcomms2_sink_0_0 = iio.fmcomms2_sink_f32c('192.168.2.1', lo_freq, 2304000, 300000, True, False, 0x8000, False, 'A', 10.0, 10.0, '', True)
...
def main(top_block_cls=c4fm_tx_params, options=None):
